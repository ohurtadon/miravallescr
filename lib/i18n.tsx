...
const translations: Record<Locale, Record<TranslationKey, string>> = {
  es: {
    ...
    "hero.copy": "Explora atractivos, experiencias y negocios locales de la Cordillera Volcánica de Guanacaste.",
...
const valueTranslations: Record<Locale, Record<string, string>> = {
  ...
  en: {
    ...
    "Explora atractivos, experiencias y negocios locales de la Cordillera Volcánica de Guanacaste.": "Explore attractions, experiences, and local businesses across the Guanacaste Volcanic Mountain Range.",
