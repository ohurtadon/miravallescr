      ...
      <div className="relative mx-auto flex min-h-[102svh] max-w-7xl items-end px-5 pb-20 pt-32 md:px-8 md:pb-24">
        ...
        >
          <motion.div
            ...
            className="mb-6 inline-flex min-h-11 items-center gap-2 rounded-full bg-white/14 px-4 py-2 text-sm font-semibold ring-1 ring-white/25 backdrop-blur"
          >
          ...
          <motion.h1
            variants={reduceMotion ? undefined : staggerItem}
            className="font-display text-5xl font-bold leading-[0.98] text-white text-balance drop-shadow-[0_3px_18px_rgba(0,0,0,0.45)] md:text-7xl lg:text-8xl"
          >
            {t("hero.title")}
          </motion.h1>
          <motion.p
            variants={reduceMotion ? undefined : staggerItem}
            className="mt-6 max-w-2xl text-lg font-medium leading-8 text-white md:text-xl"
          >
            {t("hero.copy")}
          </motion.p>
          <motion.div variants={reduceMotion ? undefined : staggerItem} className="mt-9 flex flex-col gap-3 sm:flex-row">
            <Link
              href="#atractivos"
