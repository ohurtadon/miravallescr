...
export function ExperienceCard({ experience }: ExperienceCardProps) {
  return (
    <article className="overflow-hidden rounded-lg bg-white shadow-sm ring-1 ring-canopy/10 transition hover:-translate-y-1 hover:shadow-soft">
      ...
      <div className="p-6">
        <p className="text-xs font-bold uppercase tracking-[0.18em] text-moss">{experience.category}</p>
        ...
        <div className="mt-6 grid gap-2 sm:grid-cols-2">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 rounded-md bg-mist px-4 py-3 text-sm font-bold text-canopy ring-1 ring-canopy/10 transition hover:bg-sand"
          >
